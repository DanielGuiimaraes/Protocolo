                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="pessoa"><g:message code="secUser.pessoa.label" default="Pessoa" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: secUserInstance, field: 'pessoa', 'errors')}">
                                    <g:select name="pessoa.id" from="${protocolo1_1.Pessoa.list()}" optionKey="id" value="${secUserInstance?.pessoa?.id}"  />
                                </td>
                            </tr>
